...
import 'package:taptap/pm_font.dart';
import 'package:taptap/pm_font_reader.dart';
import 'package:taptap/pm_font_table.dart';
import 'package:taptap/pm_animation_utiils.dart';
import 'package:taptap/pm_painter.dart';
...
class _Home extends State<Home> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    rootBundle.load("assets/fonts/tabtab_hangul.ttf").then((ByteData data) {
      ...
      myPath1 = myFont.generatePathForCharacter(0xAC00);
